...
from train_lstm_4 import FlightDataset, load_flight_data  # 从训练脚本中导入 FlightDataset
...
model = LSTMModel(input_dim=4, hidden_dim=32).to(device)   #hidden_dim=64对应ETH数据
model.load_state_dict(torch.load("../models/MY_lstm_4/my_lstm_model.pt"))
model.eval()
...
scaler_x.mean_ = np.load("../models/MY_lstm_4/my_input_mean.npy")
scaler_x.scale_ = np.load("../models/MY_lstm_4/my_input_std.npy")
scaler_y.mean_ = np.load("../models/MY_lstm_4/my_aoa_mean.npy")
scaler_y.scale_ = np.load("../models/MY_lstm_4/my_aoa_std.npy")
