...
class LSTMModel(nn.Module):
    def __init__(self, input_dim, hidden_dim=32):       #ETH数据hidden_dim=64,自己的数据hidden_dim=32
...
def preprocess():
    ...
    SAVE_DIR = os.path.join(BASE_DIR, "..", "models", "MY_lstm_10")
...
def train():
    ...
    # 获取 train_lstm.py 的绝对路径
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    MODEL_DIR = os.path.join(BASE_DIR, "..", "models", "MY_lstm_10")
