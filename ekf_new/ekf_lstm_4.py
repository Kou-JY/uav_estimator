...
from lstm_csv.train_lstm_4 import FlightDataset, load_flight_data  # 从训练脚本中导入 FlightDataset
...
lstm_model = LSTMModel(input_dim=4).to(device)
lstm_model.load_state_dict(torch.load("../lstm_csv/lstm_model_4.pt", map_location=device))
lstm_model.eval()
...
scaler_x.mean_ = np.load("../lstm_csv/input_mean_4.npy")
scaler_x.scale_ = np.load("../lstm_csv/input_std_4.npy")
scaler_y.mean_ = np.load("../lstm_csv/aoa_mean_4.npy")
scaler_y.scale_ = np.load("../lstm_csv/aoa_std_4.npy")
